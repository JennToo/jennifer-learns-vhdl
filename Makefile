...
$(eval $(call DEFINE_BITSTREAM,ulx3s_sdram_test,src/util.vhd src/basic_sdram.vhd src/memtester.vhd synth/ulx3s/sdram_test/toplevel.vhd,--clkin 25 --clkout0 100))
